"""
Gera um pacote Anki (.apkg) a partir de perguntas-nucleo-dicionarios.csv, anexando a
imagem confirmada de cada agente/necessidade (imagens_agentes/<agente>/manifest.json).

Estrutura reutilizavel/DRY: um unico modelo de nota (Front/Back) e um unico template sao
usados para TODOS os tipos de pergunta (Categoria/Transmissao/Achado/Vinheta/Aplicado) e
para as duas disciplinas -- nao ha template duplicado por tipo. "Vinheta (agente)"
...
"Nucleo::Micologia"), e a copia de midia e isolada na classe BancoDeMidia.

Uso:
    python montar_deck.py
"""
...
# existentes no Anki em vez de duplicar o deck inteiro.
